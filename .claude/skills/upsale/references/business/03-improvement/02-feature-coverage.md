# Improvement Aspect — Feature Coverage

**Track:** business · **Aspect:** 02 of 12 · **Slug:** `feature-coverage`
...
**Output:** `plans/upsale/business/03-improvement/02-feature-coverage.md`
**Template:** `templates/business/03-improvement/02-feature-coverage.md`
